    ...
    async def execute_command(
        ...
        Args:
            permission_mode: One of "default", "acceptEdits", "plan",
                "bypassPermissions". When None, the SDK's own default is used.
        """
        ...
        try:
            ...
            # Validate permission_mode against the SDK's enum.
            valid_modes = {"default", "acceptEdits", "plan", "bypassPermissions"}
            sdk_permission_mode = (
                permission_mode if permission_mode in valid_modes else None
            )
            ...
            if sdk_permission_mode is not None:
                options_kwargs["permission_mode"] = sdk_permission_mode
                logger.info(
                    "Permission mode set for session",
            ...
            # Extract cost, tools, session_id, and token usage from result message
            cost = 0.0
