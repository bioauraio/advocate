...
class Settings(BaseSettings):
    ...
    allowed_chats: Optional[List[int]] = Field(
        None,
        description="Allowed Telegram chat IDs (groups). Any user writing in "
        "these chats is allowed without being in allowed_users.",
    )
    ...
    @field_validator(
        "allowed_users", "allowed_chats", "notification_chat_ids", mode="before"
    )
    @classmethod
